    ...
    <div class="col-md-3">
        ...
        <div class="col-md-9">
            <div class="card ">
                ...
                <div class="card-body">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                         ...
                         session_start();
                        $d=Date('yyyy-mm-dd');
                         $sql="SELECT * FROM notices WHERE status =1 and $d>end_date";
                ...
                if($_SESSION['messagesuccess'] && !empty($_SESSION['messagesuccess'])){ 
...
$query="UPDATE notices SET subject='$_POST[subject]',message='$_POST[message]',end_date='$_POST[end_date]' WHERE id='$_POST[id]'";
$result=mysqli_query($conn,$query);
    if($result)
    {
        echo '<script type="text/javascript">alert("notice updated successful")</script>';
    }
    else
    {
         echo '<script type="text/javascript">alert("notice not updated successful")</script>';
    }
    }
?>
</html>